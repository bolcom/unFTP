...
```sh
curl -L https://github.com/bolcom/unFTP/releases/download/v0.13.3/unftp_x86_64-unknown-linux-musl \
...
```sh
curl -L https://github.com/bolcom/unFTP/releases/download/v0.13.3/unftp_x86_64-unknown-linux-gnu \
  | sudo tee /usr/local/bin/unftp > /dev/null && sudo chmod +x /usr/local/bin/unftp
```
...
```sh
curl -L https://github.com/bolcom/unFTP/releases/download/v0.13.3/unftp_x86_64-apple-darwin \
  | sudo tee /usr/local/bin/unftp > /dev/null && sudo chmod +x /usr/local/bin/unftp
```
